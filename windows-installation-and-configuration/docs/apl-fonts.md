...
You may use either a bitmap font or a TrueType font in your APL session (see " Session Operations" on page 1
UI Guide: 

Session Operations for details). You MUST use a TrueType font for printing APL functions.
