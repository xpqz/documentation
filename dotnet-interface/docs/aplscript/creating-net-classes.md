...
![aplclasses6_1](site:img/aplclasses6-1.png)
...
![aplclasses7_1](site:img/aplclasses7-1.png)
...
![aplclasses7_2](site:img/aplclasses7-2.png)

Now click **Debug/Start Without debugging**(or press Ctrl+F5) to run the program. The results are shown in a console window.

![aplclasses7_3](site:img/aplclasses7-3.png)
